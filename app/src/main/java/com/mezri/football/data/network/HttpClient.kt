...
import com.mezri.football.CACHE_MAX_AGE
import com.mezri.football.CACHE_SIZE
        ...
        if (client == null) {
            ...
            httpBuilder
                ...
                .addInterceptor {
                    ...
                    // set header to check if there is a cache not older than 30 seconds in this case
